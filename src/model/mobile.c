#include "../../include/model/mobile.h"

void mobile_init(struct MobileNet* mobile)
{
    // Initialize conv1
    for(int i = 0; i < 64; ++i){
...
void mobile_destroy(struct MobileNet* mobile)
{
    for(int i = 0; i < 64; ++i){
...
void mobile_load_param(struct MobileNet* mobile)
{   
...
struct Tensor** mobile_run(struct MobileNet* mobile, struct Tensor* input)
{   
